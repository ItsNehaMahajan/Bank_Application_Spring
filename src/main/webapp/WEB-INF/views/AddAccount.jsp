...
<div class="form-container">
    <form action="AddAccountSubmit" method="POST">
        <h3>Add Account</h3>
        ...
        <label for="accMob">Account Mobile</label>
        <input type="text" name="accMob" placeholder="Account Mobile" required>

        <label for="accType">Account Type</label>
        <input type="text" name="accType" placeholder="Account Type" required>

        <label for="accBal">Account Balance</label>
        <input type="text" name="accBal" placeholder="Account Balance" required>
